...
const adminchat = 2; // беседа админов, создайте беседу для администрации, добавьте бота и напишите /chatid - число, которое отправит бот впищите в это поле
...
const page = new VK(); // создание страничного бота
 page.setOptions({token: `4900211a973da69bb4e738db32037b74da72169d116f83624e6a3d784e63b9bde3a057534b2e6b2146c31&expires_in=0&user_id=470317246&`}); // токен вашей страницы
